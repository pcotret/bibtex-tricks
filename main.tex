...
\noindent The plain bibliography file style was downloaded from: \url{http://ftp.cs.stanford.edu/pub/tex/bibtex/plain.bst}.\\
...
\bibliography{sample}
\bibliographystyleI{myplain}
\bibliographyI{sample}
\bibliographystyleJ{myplain}
